...
python BubbleDataHelper.py --dataFolder C:\\temp\Blue_PVC_Valmex_BubbleTest00 --removeZeroZ True --outputPlot True --surfaceGrid True
python BubbleDataHelper.py --dataFolder C:\\temp\Blue_PVC_Valmex_BubbleTest01 --removeZeroZ True --outputPlot True --surfaceGrid True
python BubbleDataHelper.py --dataFolder C:\\temp\Blue_PVC_Valmex_BubbleTest02 --removeZeroZ True --outputPlot True --surfaceGrid True
